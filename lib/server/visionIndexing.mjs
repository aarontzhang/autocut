...
const DEFAULT_INDEX_SEGMENT_CONCURRENCY = clamp(Math.floor(HOST_PARALLELISM / 2), 1, 6);
...
const INDEX_DESCRIPTION_CONCURRENCY = normalizeConcurrency(
  ...
  clamp(Math.ceil(DEFAULT_INDEX_SEGMENT_CONCURRENCY / 2), 1, 4),
);
...
function normalizeConcurrency(value, fallback, max = 8) {
