...
function ManagePanel() {
  ...
  if (loading) {
    return (
      <div style={{ width: '100%', maxWidth: 380, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    <div style={{ width: '100%', maxWidth: 380 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 6,
          borderRadius: '50%',
          background: isCanceling ? '#f87171' : '#21d4ff',
          boxShadow: `0 0 8px ${isCanceling
        ...
        <span style={{
          fontSize: 11.5,
          fontWeight: 600,
          color: isCanceling ? '#f87171' : '#21d4ff',
